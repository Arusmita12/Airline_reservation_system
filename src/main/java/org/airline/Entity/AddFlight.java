...
public class AddFlight {
	...
	public AddFlight(long flightNo, String to, String from, String flightName, String departure, String duration,
	...
	public String toString() {
		return "AddFlight [flightNo=" + flightNo + ", To=" + To + ", From=" + From + ", flightName=" + flightName
